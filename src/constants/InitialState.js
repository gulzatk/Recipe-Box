...
export const initialState = {
  recipes: {
    "1": {
      ...
      type: "salads",
      ingredients:
        "1 Butter Lettuce, 2 cups Fresh Sweet Peas, 1 cup Mangetout, 1-2 Spring Onions 2 Green Peppers 1½ cup Cherry Tomatoes, 5 tbsp Extra Virgin Olive Oil, 1 tbsp Lemon Juice, 2 tbsp Honey, A few Fresh Mint Leaves",
      instructions:
        "Wash all the salad ingredients first. Cut lettuce into thin strips, shell peas and slice spring onions. Cut green peppers into thin strips (or dice). Half the tomatoes. Combine olive oil, lemon juice, honey and chopped mint leaves and pour over the salad right before serving.",
      likes: 0,
      dislikes: 0,
      recipeId: 1
    },
    "2": {
      ...
      type: "appetizers",
      ingredients:
        "8 hard-boiled large eggs, 1 package(3 ounces) smoked salmon or lox, finely chopped, 6 tablespoons sour cream,1 tablespoon chopped fresh dill or 1 teaspoon dill weed, 1 teaspoon cider vinegar, 1 teaspoon Dijon mustard, 1/4 teaspoon cayenne pepper",
      instructions:
